...
WithdrawManualInsertModel withdrawManualInsertModelFromJson(String str) => WithdrawManualInsertModel.fromJson(json.decode(str));

String withdrawManualInsertModelToJson(WithdrawManualInsertModel data) => json.encode(data.toJson());
...
class WithdrawManualInsertModel {
  ...
  factory WithdrawManualInsertModel.fromJson(Map<String, dynamic> json) => WithdrawManualInsertModel(
