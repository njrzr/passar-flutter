...
//
//     final addMoneyPaymentGatewayModel = addMoneyPaymentGatewayModelFromJson(jsonString);

import 'dart:convert';

AddMoneyPaymentGatewayModel addMoneyPaymentGatewayModelFromJson(String str) => AddMoneyPaymentGatewayModel.fromJson(json.decode(str));

String addMoneyPaymentGatewayModelToJson(AddMoneyPaymentGatewayModel data) => json.encode(data.toJson());
...
class AddMoneyPaymentGatewayModel {
  ...
  factory AddMoneyPaymentGatewayModel.fromJson(Map<String, dynamic> json) => AddMoneyPaymentGatewayModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    gateways: List<Gateway>.from(json["gateways"].map((x) => Gateway.fromJson(x))),
    transactionss: List<Transactionss>.from(json["transactionss"].map((x) => Transactionss.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "transactionss": List<dynamic>.from(transactionss.map((x) => x.toJson())),
  };
}
