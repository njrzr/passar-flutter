...
import 'package:passar/controller/categories/virtual_card/sudo_virtual_card/virtual_card_sudo_controller.dart';
...
class SudoAddFundController extends GetxController {
  ...
  RxDouble getFee({required double rate}) {
    double value = virtualCardController.fixedCharge.value * rate;
    value = value +
        (double.parse(amountTextController.text.isEmpty
                ? '0.0'
                : amountTextController.text) *
            (virtualCardController.percentCharge.value / 100));
